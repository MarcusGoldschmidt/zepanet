...
********************************************************************/
  ...
  int  DLLEXPORT ENepanet(const char *inpFile, const char *rptFile, const char *outFile, void (*pviewprog) (char *));

  int  DLLEXPORT ENinit(const char *rptFile, const char *outFile, int unitsType, int headlossType);
...
********************************************************************/
  ...
  int  DLLEXPORT ENgetqualinfo(int *qualType, char *chemName, char *chemUnits, int *traceNode);

  int  DLLEXPORT ENgetqualtype(int *qualType, int *traceNode);

  int  DLLEXPORT ENsetqualtype(int qualType, char *chemName, char *chemUnits, char *traceNode);
...
********************************************************************/
   ...
   int DLLEXPORT ENsetjuncdata(int index, EN_API_FLOAT_TYPE elev, EN_API_FLOAT_TYPE dmnd, char *dmndpat);

  int  DLLEXPORT ENsettankdata(int index, EN_API_FLOAT_TYPE elev, EN_API_FLOAT_TYPE initlvl, EN_API_FLOAT_TYPE minlvl, EN_API_FLOAT_TYPE maxlvl, EN_API_FLOAT_TYPE diam, EN_API_FLOAT_TYPE minvol, char *volcurve);
...
********************************************************************/
  ...
  int DLLEXPORT ENgetdemandmodel(int *model, EN_API_FLOAT_TYPE *pmin,EN_API_FLOAT_TYPE *preq, EN_API_FLOAT_TYPE *pexp);

  int DLLEXPORT ENsetdemandmodel(int model, EN_API_FLOAT_TYPE pmin,EN_API_FLOAT_TYPE preq, EN_API_FLOAT_TYPE pexp);

  int DLLEXPORT ENadddemand(int nodeIndex, EN_API_FLOAT_TYPE baseDemand,char *demandPattern, char *demandName);
...
********************************************************************/
  ...
  int DLLEXPORT ENsetpipedata(int index, EN_API_FLOAT_TYPE length,EN_API_FLOAT_TYPE diam, EN_API_FLOAT_TYPE rough,EN_API_FLOAT_TYPE mloss);
...
********************************************************************/
  ...
  int DLLEXPORT ENgetcurve(int index, char* id, int *nPoints,EN_API_FLOAT_TYPE *xValues, EN_API_FLOAT_TYPE *yValues);

  int DLLEXPORT ENsetcurve(int index, EN_API_FLOAT_TYPE *xValues,EN_API_FLOAT_TYPE *yValues, int nPoints);
...
********************************************************************/
  ...
  int DLLEXPORT ENaddcontrol(int type, int linkIndex, EN_API_FLOAT_TYPE setting,int nodeIndex, EN_API_FLOAT_TYPE level, int *index);

  int DLLEXPORT ENdeletecontrol(int index);

  int DLLEXPORT ENgetcontrol(int index, int *type, int *linkIndex,EN_API_FLOAT_TYPE *setting, int *nodeIndex, EN_API_FLOAT_TYPE *level);

  int DLLEXPORT ENsetcontrol(int index, int type, int linkIndex,EN_API_FLOAT_TYPE setting, int nodeIndex, EN_API_FLOAT_TYPE level);
...
********************************************************************/
  ...
  int DLLEXPORT ENgetrule(int index, int *nPremises, int *nThenActions,int *nElseActions, EN_API_FLOAT_TYPE *priority);
