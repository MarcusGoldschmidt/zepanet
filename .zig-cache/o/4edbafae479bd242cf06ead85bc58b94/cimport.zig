...
pub extern fn ENepanet(inpFile: [*c]const u8, rptFile: [*c]const u8, outFile: [*c]const u8, pviewprog: ?*const fn ([*c]u8) callconv(.c) void) c_int;
pub extern fn ENinit(rptFile: [*c]const u8, outFile: [*c]const u8, unitsType: c_int, headlossType: c_int) c_int;
pub extern fn ENopen(inpFile: [*c]const u8, rptFile: [*c]const u8, outFile: [*c]const u8) c_int;
pub extern fn ENgettitle(line1: [*c]u8, line2: [*c]u8, line3: [*c]u8) c_int;
pub extern fn ENsettitle(line1: [*c]u8, line2: [*c]u8, line3: [*c]u8) c_int;
pub extern fn ENgetcomment(object: c_int, index: c_int, comment: [*c]u8) c_int;
pub extern fn ENsetcomment(object: c_int, index: c_int, comment: [*c]u8) c_int;
pub extern fn ENgetcount(object: c_int, count: [*c]c_int) c_int;
pub extern fn ENsaveinpfile(filename: [*c]const u8) c_int;
pub extern fn ENclose(...) c_int;
pub extern fn ENsolveH(...) c_int;
pub extern fn ENsaveH(...) c_int;
pub extern fn ENopenH(...) c_int;
pub extern fn ENinitH(initFlag: c_int) c_int;
pub extern fn ENrunH(currentTime: [*c]c_long) c_int;
pub extern fn ENnextH(tStep: [*c]c_long) c_int;
pub extern fn ENcloseH(...) c_int;
pub extern fn ENsavehydfile(filename: [*c]u8) c_int;
pub extern fn ENusehydfile(filename: [*c]u8) c_int;
pub extern fn ENsolveQ(...) c_int;
pub extern fn ENopenQ(...) c_int;
pub extern fn ENinitQ(saveFlag: c_int) c_int;
pub extern fn ENrunQ(currentTime: [*c]c_long) c_int;
pub extern fn ENnextQ(tStep: [*c]c_long) c_int;
pub extern fn ENstepQ(timeLeft: [*c]c_long) c_int;
pub extern fn ENcloseQ(...) c_int;
pub extern fn ENwriteline(line: [*c]u8) c_int;
pub extern fn ENreport(...) c_int;
pub extern fn ENcopyreport(filename: [*c]u8) c_int;
pub extern fn ENclearreport(...) c_int;
pub extern fn ENresetreport(...) c_int;
pub extern fn ENsetreport(format: [*c]u8) c_int;
pub extern fn ENsetstatusreport(level: c_int) c_int;
pub extern fn ENgetversion(version: [*c]c_int) c_int;
pub extern fn ENgeterror(errcode: c_int, errmsg: [*c]u8, maxLen: c_int) c_int;
pub extern fn ENgetstatistic(@"type": c_int, value: [*c]f32) c_int;
pub extern fn ENgetresultindex(@"type": c_int, index: c_int, value: [*c]c_int) c_int;
pub extern fn ENgetoption(option: c_int, value: [*c]f32) c_int;
pub extern fn ENsetoption(option: c_int, value: f32) c_int;
pub extern fn ENgetflowunits(units: [*c]c_int) c_int;
pub extern fn ENsetflowunits(units: c_int) c_int;
pub extern fn ENgettimeparam(param: c_int, value: [*c]c_long) c_int;
pub extern fn ENsettimeparam(param: c_int, value: c_long) c_int;
pub extern fn ENgetqualinfo(qualType: [*c]c_int, chemName: [*c]u8, chemUnits: [*c]u8, traceNode: [*c]c_int) c_int;
pub extern fn ENgetqualtype(qualType: [*c]c_int, traceNode: [*c]c_int) c_int;
pub extern fn ENsetqualtype(qualType: c_int, chemName: [*c]u8, chemUnits: [*c]u8, traceNode: [*c]u8) c_int;
pub extern fn ENaddnode(id: [*c]u8, nodeType: c_int, index: [*c]c_int) c_int;
pub extern fn ENdeletenode(index: c_int, actionCode: c_int) c_int;
pub extern fn ENgetnodeindex(id: [*c]u8, index: [*c]c_int) c_int;
pub extern fn ENgetnodeid(index: c_int, id: [*c]u8) c_int;
pub extern fn ENsetnodeid(index: c_int, newid: [*c]u8) c_int;
pub extern fn ENgetnodetype(index: c_int, nodeType: [*c]c_int) c_int;
pub extern fn ENgetnodevalue(index: c_int, property: c_int, value: [*c]f32) c_int;
pub extern fn ENsetnodevalue(index: c_int, property: c_int, value: f32) c_int;
pub extern fn ENsetjuncdata(index: c_int, elev: f32, dmnd: f32, dmndpat: [*c]u8) c_int;
pub extern fn ENsettankdata(index: c_int, elev: f32, initlvl: f32, minlvl: f32, maxlvl: f32, diam: f32, minvol: f32, volcurve: [*c]u8) c_int;
pub extern fn ENgetcoord(index: c_int, x: [*c]f64, y: [*c]f64) c_int;
pub extern fn ENsetcoord(index: c_int, x: f64, y: f64) c_int;
pub extern fn ENgetdemandmodel(model: [*c]c_int, pmin: [*c]f32, preq: [*c]f32, pexp: [*c]f32) c_int;
pub extern fn ENsetdemandmodel(model: c_int, pmin: f32, preq: f32, pexp: f32) c_int;
pub extern fn ENadddemand(nodeIndex: c_int, baseDemand: f32, demandPattern: [*c]u8, demandName: [*c]u8) c_int;
pub extern fn ENdeletedemand(nodeIndex: c_int, demandIndex: c_int) c_int;
pub extern fn ENgetnumdemands(nodeIndex: c_int, numDemands: [*c]c_int) c_int;
pub extern fn ENgetdemandindex(nodeIndex: c_int, demandName: [*c]u8, demandIndex: [*c]c_int) c_int;
pub extern fn ENgetbasedemand(nodeIndex: c_int, demandIndex: c_int, baseDemand: [*c]f32) c_int;
pub extern fn ENsetbasedemand(nodeIndex: c_int, demandIndex: c_int, baseDemand: f32) c_int;
pub extern fn ENgetdemandpattern(nodeIndex: c_int, demandIndex: c_int, patIndex: [*c]c_int) c_int;
pub extern fn ENsetdemandpattern(nodeIndex: c_int, demandIndex: c_int, patIndex: c_int) c_int;
pub extern fn ENgetdemandname(nodeIndex: c_int, demandIndex: c_int, demandName: [*c]u8) c_int;
pub extern fn ENsetdemandname(nodeIndex: c_int, demandIndex: c_int, demandName: [*c]u8) c_int;
pub extern fn ENaddlink(id: [*c]u8, linkType: c_int, fromNode: [*c]u8, toNode: [*c]u8, index: [*c]c_int) c_int;
pub extern fn ENdeletelink(index: c_int, actionCode: c_int) c_int;
pub extern fn ENgetlinkindex(id: [*c]u8, index: [*c]c_int) c_int;
pub extern fn ENgetlinkid(index: c_int, id: [*c]u8) c_int;
pub extern fn ENsetlinkid(index: c_int, newid: [*c]u8) c_int;
pub extern fn ENgetlinktype(index: c_int, linkType: [*c]c_int) c_int;
pub extern fn ENsetlinktype(index: [*c]c_int, linkType: c_int, actionCode: c_int) c_int;
pub extern fn ENgetlinknodes(index: c_int, node1: [*c]c_int, node2: [*c]c_int) c_int;
pub extern fn ENsetlinknodes(index: c_int, node1: c_int, node2: c_int) c_int;
pub extern fn ENgetlinkvalue(index: c_int, property: c_int, value: [*c]f32) c_int;
pub extern fn ENsetlinkvalue(index: c_int, property: c_int, value: f32) c_int;
pub extern fn ENsetpipedata(index: c_int, length: f32, diam: f32, rough: f32, mloss: f32) c_int;
pub extern fn ENgetvertexcount(index: c_int, count: [*c]c_int) c_int;
pub extern fn ENgetvertex(index: c_int, vertex: c_int, x: [*c]f64, y: [*c]f64) c_int;
pub extern fn ENsetvertices(index: c_int, x: [*c]f64, y: [*c]f64, count: c_int) c_int;
pub extern fn ENgetpumptype(linkIndex: c_int, pumpType: [*c]c_int) c_int;
pub extern fn ENgetheadcurveindex(linkIndex: c_int, curveIndex: [*c]c_int) c_int;
pub extern fn ENsetheadcurveindex(linkIndex: c_int, curveIndex: c_int) c_int;
pub extern fn ENaddpattern(id: [*c]u8) c_int;
pub extern fn ENdeletepattern(index: c_int) c_int;
pub extern fn ENgetpatternindex(id: [*c]u8, index: [*c]c_int) c_int;
pub extern fn ENgetpatternid(index: c_int, id: [*c]u8) c_int;
pub extern fn ENsetpatternid(index: c_int, id: [*c]u8) c_int;
pub extern fn ENgetpatternlen(index: c_int, len: [*c]c_int) c_int;
pub extern fn ENgetpatternvalue(index: c_int, period: c_int, value: [*c]f32) c_int;
pub extern fn ENsetpatternvalue(index: c_int, period: c_int, value: f32) c_int;
pub extern fn ENgetaveragepatternvalue(index: c_int, value: [*c]f32) c_int;
pub extern fn ENsetpattern(index: c_int, values: [*c]f32, len: c_int) c_int;
pub extern fn ENaddcurve(id: [*c]u8) c_int;
pub extern fn ENdeletecurve(index: c_int) c_int;
pub extern fn ENgetcurveindex(id: [*c]u8, index: [*c]c_int) c_int;
pub extern fn ENgetcurveid(index: c_int, id: [*c]u8) c_int;
pub extern fn ENsetcurveid(index: c_int, id: [*c]u8) c_int;
pub extern fn ENgetcurvelen(index: c_int, len: [*c]c_int) c_int;
pub extern fn ENgetcurvetype(index: c_int, @"type": [*c]c_int) c_int;
pub extern fn ENgetcurvevalue(curveIndex: c_int, pointIndex: c_int, x: [*c]f32, y: [*c]f32) c_int;
pub extern fn ENsetcurvevalue(curveIndex: c_int, pointIndex: c_int, x: f32, y: f32) c_int;
pub extern fn ENgetcurve(index: c_int, id: [*c]u8, nPoints: [*c]c_int, xValues: [*c]f32, yValues: [*c]f32) c_int;
pub extern fn ENsetcurve(index: c_int, xValues: [*c]f32, yValues: [*c]f32, nPoints: c_int) c_int;
pub extern fn ENaddcontrol(@"type": c_int, linkIndex: c_int, setting: f32, nodeIndex: c_int, level: f32, index: [*c]c_int) c_int;
pub extern fn ENdeletecontrol(index: c_int) c_int;
pub extern fn ENgetcontrol(index: c_int, @"type": [*c]c_int, linkIndex: [*c]c_int, setting: [*c]f32, nodeIndex: [*c]c_int, level: [*c]f32) c_int;
pub extern fn ENsetcontrol(index: c_int, @"type": c_int, linkIndex: c_int, setting: f32, nodeIndex: c_int, level: f32) c_int;
pub extern fn ENaddrule(rule: [*c]u8) c_int;
pub extern fn ENdeleterule(index: c_int) c_int;
pub extern fn ENgetrule(index: c_int, nPremises: [*c]c_int, nThenActions: [*c]c_int, nElseActions: [*c]c_int, priority: [*c]f32) c_int;
pub extern fn ENgetruleID(index: c_int, id: [*c]u8) c_int;
pub extern fn ENgetpremise(ruleIndex: c_int, premiseIndex: c_int, logop: [*c]c_int, object: [*c]c_int, objIndex: [*c]c_int, variable: [*c]c_int, relop: [*c]c_int, status: [*c]c_int, value: [*c]f32) c_int;
pub extern fn ENsetpremise(ruleIndex: c_int, premiseIndex: c_int, logop: c_int, object: c_int, objIndex: c_int, variable: c_int, relop: c_int, status: c_int, value: f32) c_int;
pub extern fn ENsetpremiseindex(ruleIndex: c_int, premiseIndex: c_int, objIndex: c_int) c_int;
pub extern fn ENsetpremisestatus(ruleIndex: c_int, premiseIndex: c_int, status: c_int) c_int;
pub extern fn ENsetpremisevalue(ruleIndex: c_int, premiseIndex: c_int, value: f32) c_int;
pub extern fn ENgetthenaction(ruleIndex: c_int, actionIndex: c_int, linkIndex: [*c]c_int, status: [*c]c_int, setting: [*c]f32) c_int;
pub extern fn ENsetthenaction(ruleIndex: c_int, actionIndex: c_int, linkIndex: c_int, status: c_int, setting: f32) c_int;
pub extern fn ENgetelseaction(ruleIndex: c_int, actionIndex: c_int, linkIndex: [*c]c_int, status: [*c]c_int, setting: [*c]f32) c_int;
pub extern fn ENsetelseaction(ruleIndex: c_int, actionIndex: c_int, linkIndex: c_int, status: c_int, setting: f32) c_int;
pub extern fn ENsetrulepriority(index: c_int, priority: f32) c_int;
...
pub const EPANET2_H = "";
pub const EN_API_FLOAT_TYPE = f32;
pub const DLLEXPORT = "";
